...
def RemoveSong():
    """
    Xóa bài hát đang được chọn khỏi danh sách phát.
    """
    global Song_selected
...
def ClearPlaylist():
    """
    Xóa tất cả các bài hát khỏi danh sách phát.
    """
    global Song_selected
...
def PreviousSong():
   ...
   if current_index:
       ...
       Song_selected = True
       mixer.music.load(Playlist.get(previous_index))
       mixer.music.play()
       count = 0

# Định nghĩa hàm NextSong
def NextSong():
   global count
   global Song_selected
   current_index = Playlist.curselection()
   if current_index:
       ...
       Song_selected = True
       mixer.music.load(Playlist.get(next_index))
       mixer.music.play()
       count = 0
...
buttonplay = Button(root, image=ButtonPlay1, bg="#7e36b4", bd=0, highlightbackground="#7e36b4", activebackground="#7e36b4", cursor="hand2", command=PlayMusic)
...
buttonstop = Button(root, image=ButtonStop1, bg="#7e36b4", bd=0, highlightbackground="#7e36b4", activebackground="#7e36b4", cursor="hand2", command=onstop)
...
buttonresume = Button(root, image=ButtonResume1, bg="#7e36b4", bd=0, highlightbackground="#7e36b4", activebackground="#7e36b4", cursor="hand2", command=onresume)
...
buttonpause = Button(root, image=ButtonPause1, bg="#7e36b4", bd=0, highlightbackground="#7e36b4", activebackground="#7e36b4", cursor="hand2", command=onpause)
...
# Tạo nút Previous
# ----------------------------------PREVIOUS------------------------
ButtonPrevious = ImageTk.PhotoImage(ButtonPrevious)
buttonpre = Button(root, image=ButtonPrevious, bg="#7e36b4", bd=0, highlightbackground="#7e36b4", activebackground="#7e36b4", cursor="hand2", command=PreviousSong)
buttonpre.place(x=620, y=560)

# ----------------------------------NEXT------------------------
# Tạo nút Next
# ----------------------------------NEXT------------------------
ButtonNext = ImageTk.PhotoImage(ButtonNext)
buttonnext = Button(root, image=ButtonNext, bg="#7e36b4", bd=0, highlightbackground="#7e36b4", activebackground="#7e36b4", cursor="hand2", command=NextSong)
buttonnext.place(x=660, y=560)

# Tạo nút Xóa bài hát
ButtonRemoveSong = ImageTk.PhotoImage(ButtonRemoveSong)
buttonremove = Button(root, image=ButtonRemoveSong, bg="#7e36b4", bd=0, highlightbackground="#7e36b4", activebackground="#7e36b4", cursor="hand2", command=RemoveSong)
buttonremove.place(x=560, y=560)

# Tạo nút Xóa tất cả
ButtonClearPlaylist = ImageTk.PhotoImage(ButtonClearPlaylist)
buttonclear = Button(root, image=ButtonClearPlaylist, bg="#7e36b4", bd=0, highlightbackground="#7e36b4", activebackground="#7e36b4", cursor="hand2", command=ClearPlaylist)
buttonclear.place(x=720, y=560)
